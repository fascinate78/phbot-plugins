...
| [FAutoUnique V2](plugins/FAutoUnique/) | 3.2.3 | Hunts unique monsters through prioritized script or learned coordinate routes. |
...
| [FWheelManager](plugins/FWheelManager/) | 1.6.1 | Combines Fate, Fortune, and Pen equipment rolling into one safely coordinated phBot plugin. |
<!-- PLUGIN_TABLE_END -->
